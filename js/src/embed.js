/**
 * Created by wshunli on 16/11/22.
 */
 //管理员判断开始
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 10145649) {
        if (checkMobile()) {
            ...
            userUrl: function (e) {
                ...
                if (document.location.protocol == "https:") {
                    if (e.avatar_url) {
                        ...
                        e.avatar_url = e.avatar_url.replace(/tva\d+\.sinaimg\.cn/, "wbimg-tva2.b0.upaiyun.com");
        ...
        it.on("queryDefined", function () {
            ...
            function R(e, t) {
                ...
                function d() {
                    ...
                    return i[0] ? (i.remove(), !1) : (i = B('<ul class="ds-children"></ul>').insertAfter(s), A.get("posts/listComments", H({post_id: a}), e), !1)
                }
            ...
            e.postMessage && (e.addEventListener ? e.addEventListener("message", g, !1) : e.attachEvent && e.attachEvent("onmessage", g)), S.scrollTo = function (e) {
                ...
                init: function (e, t) {
                    (this.el = B("#ds-wrapper"))[0] || (this.el = p(B('<div id="ds-wrapper"></div>'))), this.options = B.extend({width: 600}, t), e !== s && B(e).attr("id", "ds-reset").appendTo(this.el)
                }, open: function () {
                    function e(e) {
                ...
                e = e || {};
                var s = this, a = s.el = e.el || B('<div class="ds-paginator"></div>'), i = s.collection = e.collection;
                ...
                render: function () {
                    ...
                    var a = "<ul>";
                    return B.each(L[e], t), a += "</ul>", this.el.find(".ds-smilies-container").html(a), this
                }
            }, et.postPlaceholder = function () {
                return ['<li class="ds-post ds-post-placeholder">', z.no_comments_yet, "</li>"].join("")
            };
            var X = B('<div id="ds-bubble"><div class="ds-bubble-content"></div><div class="ds-arrow ds-arrow-down ds-arrow-border"></div><div class="ds-arrow ds-arrow-down"></div></div>'), K = X.find(".ds-bubble-content").delegate("a.ds-ctx-open", "click", function () {
                function e(e) {
                    function t(e, t) {
            ...
            X.mouseenter(N).mouseleave(I), st.PostList = function (e) {
                ...
                onload: function (t) {
                    ...
                    a.model = new G(a.data = t.thread), lt.set(t.parentPosts || t.relatedPosts), ct.set(t.users), a.el.find("#ds-waiting").remove(), o.like_thread_enabled && (a.meta = new st.Meta(a), d.append(a.meta.render().el)), o.hot_posts && t.hotPosts && t.hotPosts.length && (a.hotPosts = new st.HotPosts(B('<div class="ds-rounded"></div>'), {
                        max_depth: 1,
                    ...
                    }), B('<div id="MZADX_' + o.mzadx_id + '" style="margin:0 auto;"></div>').appendTo(d), __mz_rpq = e.__mz_rpq || [], __mz_rpq.push({
                        l: [o.mzadx_id],
                        r: "1",
                        _srv: "MZADX",
                        _callback: function () {
